...
CREATE TABLE `promet` (
  ...
  `Datum` date NOT NULL,
  `Promet` double NOT NULL,
  PRIMARY KEY (`idPromet`),
  KEY `idProPromet` (`idProdavnica`),
  CONSTRAINT `idProPromet` FOREIGN KEY (`idProdavnica`) REFERENCES `prodavnica` (`idProdavnica`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `promet` VALUES (1,1,'2018-01-27',25500);
